...
export const stayInState = <TState extends Model.State>(state: TState) =>
  Effect.as<TState>(state);
 ...
 */
export const readyOrCommitPending = Effect.fn(
  "GraphSyncMachineTransition.readyOrCommitPending",
)(function* () {
