...
export type AuthenticatedMetadata = Schema.Schema.Type<
  typeof AuthenticatedMetadataSchema
>;

const AuthenticatedMetadataMsgPack = MsgPack.schema(
  AuthenticatedMetadataSchema,
);
