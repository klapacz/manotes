...
describe("extractBacklinkContexts", () => {
    ...
    const content = n.doc(
      ...
      n.list(
        ...
        n.list(
          { kind: "toggle", collapsed: true },
          n.paragraph("Parent"),
          n.list({ kind: "toggle", collapsed: true }, n.paragraph("Sibling before")),
          n.list(
            { kind: "toggle", collapsed: true },
            n.paragraph("Text before backlink ", n.backlink("test-id"), " Text after backlink"),
            n.list({ kind: "toggle", collapsed: true }, n.paragraph("Child")),
          ),
          n.list({ kind: "toggle", collapsed: true }, n.paragraph("Sibling after")),
        ),
      ),
  ...
  it("extracts heading context when the backlink is inside a heading", () => {
    const content = n.doc(
      ...
      n.heading(2, "Text before backlink ", n.backlink("test-id"), " Text after backlink"),
  ...
  it("returns one context per matching sibling list item", () => {
    const content = n.doc(
      ...
      n.list(
        { kind: "toggle", collapsed: true },
        n.paragraph("Parent"),
        n.list({ kind: "toggle", collapsed: true }, n.paragraph("Child A ", n.backlink("test-id"))),
        n.list({ kind: "toggle", collapsed: true }, n.paragraph("Child B ", n.backlink("test-id"))),
      ),
    );
  ...
  it("returns an empty array when no matching backlinks exist", () => {
    const content = n.doc(n.heading(1, "Note title"), n.paragraph("Text without backlinks"));
...
function setupBuilders() {
  return {
    ...
    list(attrs: ListAttrsInput, ...content: ListContentNodeJSON[]): ListNodeJSON {
      return {
        type: "list",
