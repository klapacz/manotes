...
export const sendConnect = Effect.fn("GraphSyncMachineCommands.sendConnect")(function* () {
 ...
 */
export const sendPendingCommit = Effect.fn("GraphSyncMachineCommands.sendPendingCommit")(
  function* () {
    const context = yield* MachineContext.GraphSyncMachineContext;
    const eventLog = yield* GraphSyncEventLog.Service;
