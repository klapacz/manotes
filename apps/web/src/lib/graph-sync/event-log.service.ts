...
import { MAX_EVENTS_PER_COMMIT } from "@manotes/shared/graph-sync/contract/limits";
...
export class Service extends Effect.Service<Service>()("GraphSyncEventLogService", {
  ...
  effect: Effect.gen(function* () {
    ...
    const getLastCommitSeq = Effect.fn("GraphSyncEventLogService.getLastCommitSeq")(function* () {
