...
export const listGraphs = Effect.fn("GraphRegistryRepo.listGraphs")(function* () {
...
export const createGraph = Effect.fn("GraphRegistryRepo.createGraph")(function* ({
  displayName,
  graphKeyEnvelope,
}: {
  displayName: string;
...
export const renameGraph = Effect.fn("GraphRegistryRepo.renameGraph")(function* ({
  graphId,
  displayName,
}: {
  graphId: string;
