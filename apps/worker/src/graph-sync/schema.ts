...
export const decodeNonEmptyArray = Schema.decode(Schema.NonEmptyArray(CommittedEventFromRecord));
export const decodeArray = Schema.decode(Schema.Array(CommittedEventFromRecord));

export const encodeCreateRecords = Schema.encodeSync(Schema.Array(CreateRecord));
