/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: 9e24991b6624a81cd9f234fb84b2e8fd)
// Runtime types generated with workerd@1.20260301.1 2026-03-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GraphSyncDurableObject" | "GraphRegistryDurableObject" | "AccountsDurableObject";
	}
	interface Env {
		SESSION_KV: KVNamespace;
		OTP_KV: KVNamespace;
		EMAIL: SendEmail;
		EMAIL_ADDRESS: "no-reply@sand.manotes.dev";
		ACCOUNT_ID: string;
		ACCOUNTS_DO: DurableObjectNamespace<import("./src/index").AccountsDurableObject>;
		GRAPH_SYNC_DO: DurableObjectNamespace<import("./src/index").GraphSyncDurableObject>;
		GRAPH_REGISTRY_DO: DurableObjectNamespace<import("./src/index").GraphRegistryDurableObject>;
	}
}
