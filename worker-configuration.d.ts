// Generated by Wrangler by running `wrangler types` (hash: 5466f69922e2138113f29412e9d4626a)
...
declare namespace Cloudflare {
	interface Env {
		...
		POSTHOG_KEY: string;
		POSTHOG_HOST: string;
		GRAPH_DO: DurableObjectNamespace<import("./worker/index").GraphDurableObject>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "RESEND_API_KEY" | "POSTHOG_KEY" | "POSTHOG_HOST">> {}
}
declare module "*.sql" {
	const value: string;
